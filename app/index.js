...
kbTradeMachine.run(['$rootScope', function($rootScope) {
  $rootScope.exampleTeam = {
    ...
    roster: [
      ...
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 1, id: 2, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'Team', optionYear: 3}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 1, id: 3, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'Player', optionYear: 3}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 1, id: 4, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'None', optionYear: 0}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 1, id: 5, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'None', optionYear: 0}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 1, id: 6, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'None', optionYear: 0}},
  ...
  $rootScope.exampleTeam = {
    ...
    tradeExceptions: [{value:5000000, expiration: Date(2017, 11, 7)}],
    roster: [
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 2, id: 16, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'None', optionYear: 0}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 2, id: 17, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'Team', optionYear: 3}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 2, id: 18, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'Player', optionYear: 3}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 2, id: 19, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'None', optionYear: 0}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 2, id: 20, contract: {length: 3, total: 15000000, yearByYear: [12000000, 5000000, 6000000], optionType: 'None', optionYear: 0}},
      {firstName: 'Example', lastName: 'Player', position: 3, age: 25, height: 80, weight: 240, teamId: 2, id: 21, contract: {length: 3, total: 15000000, yearByYear: [14000000, 5000000, 6000000], optionType: 'None', optionYear: 0}},
